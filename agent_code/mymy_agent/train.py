...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    # [최적화] 디버그 레벨 로그는 I/O 부하를 줄이기 위해 주석 처리하거나 로깅 레벨을 조절하세요.
    ...
    # [최적화] 대량의 주석 처리된 print 문들은 실행되진 않지만 코드 가독성을 위해 삭제 추천
...
def reward_from_events(self, events: List[str], custom_rewards) -> int:
    ...
    # [최적화] 매 스텝마다 로그를 남기면 엄청난 I/O가 발생합니다. 꼭 필요할 때만 남기세요.
